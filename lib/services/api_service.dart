...
class ApiService {
  //---------------------------------------산책로 페이지----------------------------------------------------------------------------------------
//---------------------------------------거리순 리스트 불러오기--------------------------------------------------------------------------------
  static Future<List<TraillistModel>> getNearestTrail() async {
    List<TraillistModel> NearestTrailInstances = [];
    final url = Uri.parse(
...
//---------------------------------------좋아요순 리스트 불러오기------------------------------------------------------------------------------
  static Future<List<TraillistModel>> getMostLikedTrail() async {
    List<TraillistModel> MostLikedTrailInstances = [];
    final url = Uri.parse(
...
//---------------------------------------이용자순 리스트 불러오기---------------------------------------------------------------------------
  static Future<List<TraillistModel>> getMostUsedTrail() async {
    List<TraillistModel> MostUsedTrailInstances = [];
    final url = Uri.parse(
...
//---------------------------------------최신(등록)순 리스트 불러오기-----------------------------------------------------------------------
  static Future<List<TraillistModel>> getNewTrail() async {
    List<TraillistModel> NewTrailInstances = [];
    final url = Uri.parse(
...
//--------------------------------------나만의 산책로 페이지-----------------------------------------
//------------------------------------등록한 산책로 리스트 불러오기-----------------------------------------------
  static Future<List<TraillistModel>> getCreatedTrail() async {
    List<TraillistModel> createdTrailInstances = [];
    final url = Uri.parse(
  ...
  //-----------------------------------좋아요한 산책로 리스트 불러오기-----------------------------------------------------------------------
  static Future<List<TraillistModel>> getLikedTrail() async {
    List<TraillistModel> LikedTrailInstances = [];
    final url = Uri.parse(
  ...
  //----------------------------------이용한 산책로 리스트 불러오기---------------------------------------------------------------------
  static Future<List<TraillistModel>> getUsedTrail() async {
    List<TraillistModel> UsedTrailInstances = [];
    final url = Uri.parse(
  ...
  //----------------------------------댓글단 산책로 리스트 불러오기---------------------------------------------------------------------
  static Future<List<TraillistModel>> getCommentedTrail() async {
    List<TraillistModel> CommentedTrailInstances = [];
    final url = Uri.parse(
...
//-----------------------------------키워드별 리스트 불러오기---------------------------------------------------------------------------------
  static Future<List<TraillistModel>> GetfollowedKeyTrail() async {
    List<TraillistModel> followedKeyTrailInstances = [];
    final url = Uri.parse(
