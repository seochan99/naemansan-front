...
class WebViewApple extends StatefulWidget {
  final String loginUrl;

  const WebViewApple({Key? key, required this.loginUrl}) : super(key: key);

  @override
  State<WebViewApple> createState() => _WebViewAppleState();
}

class _WebViewAppleState extends State<WebViewApple> {
        ...
        navigationDelegate: (NavigationRequest request) async {
          if (request.url.startsWith(
            ...
            var response = await http.get(
              Uri.parse(
                  "http://ossp.dcs-hyungjoon.com/auth/apple/callback?code=$code"),
            );
