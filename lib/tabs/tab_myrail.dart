...
import 'package:naemansan/screens/widgets/mytraillist.dart';
...
import 'package:naemansan/models/trailcomment.dart';
import 'package:naemansan/screens/widgets/trailcomment.dart';
import 'package:naemansan/screens/course_tabs/course_create_walk.dart';
...
// --------------------------------------- 탭별 위젯 디자인 선택
  ...
  Widget build(BuildContext context) {
    ...
    final Future<List<TraillistModel>?> EnrolledTrail =
    ...
    final Future<List<TraillistModel>?> LikedTrail =
        TrailapiService.getLikedCourses(page, num);
    final Future<List<TraillistModel>?> UsedTrail =
    ...
    final Future<List<TraillistModel>?> KeyWordTrail =
